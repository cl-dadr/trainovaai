...
import { User, Trophy, Target, Dumbbell, Crown, Lock, Settings, ChevronRight, Zap } from "lucide-react";
  ...
  return (
    <div className="relative min-h-screen pb-24 px-4 pt-6">
      ...
      >
        ...
        <p className="text-xs text-muted-foreground">Beast Mode Loading...</p>
      ...
      <motion.div
        ...
        className="relative z-10 rounded-2xl gradient-purple p-5 text-center"
      ...
      >
        ...
        <button className="glass-card px-6 py-2 rounded-xl text-sm font-bold text-foreground flex items-center gap-2 mx-auto">
